...
namespace Screen
{
	static constexpr int Width = 640;	// 幅　後で変えるかも
	static constexpr int Height = 480;	// 高さ
	...
	static constexpr Vector2 CenterLeft = Vector2(Left, Center.y);		// 中央左
	static constexpr Vector2 CenterRight = Vector2(Right, Center.y);	// 中央右
